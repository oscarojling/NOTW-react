...
export const articles = [
  new Article(
    ...
    `The highly anticipated football match between Barcelona and Bayern Munich ended in a draw last night at Wembley. Despite both teams having chances to win, neither side could find the back of the net. The match was a close contest throughout, with both teams having their fair share of possession. Barcelona had the better chances in the first half, but Bayern Munich came out stronger in the second half. In the end, the match finished 0-0, leaving both teams disappointed. Barcelona manager Hansi Flick said after the match that he was 'disappointed with the result, but proud of the players' effort. Bayern Munich manager Kompany said that he was "happy with the point, but felt that his team could have won." The draw leaves Barcelona in forst in the league table, while Bayern Munich remain in third. Both teams will be looking to improve their form in their next matches.`,
    "soccer.jpeg",
    "sport",
  ),
  new Article(
  ...
  new Article(
    ...
    `The Smith Street Theater Group is excited to announce the upcoming debut of their new play, "A Day in the Life" The play, written by local playwright Bob Graham, tells the story of Smith St. "We are thrilled to be able to bring this new play to our community," said John McIntyre. "It's a powerful and moving story that we think will resonate with audiences of all ages." The play will be performed at the Melbourne Theater from Febuary 15th to April 2nd. Tickets are on sale now and can be purchased online or at the box office. For more information, please visit the theater group's website at www.smithstreettheater.au`,
    "theatre.jpeg",
    "entertainment",
  ),
];
